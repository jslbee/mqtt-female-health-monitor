  ...
  <div>
    ...
    <div class="prediction-container">
      ...
      <div class="aesthetic-image-container">
        <img src="@/assets/images/woman.jpg" alt="Peaceful woman illustration" loading="lazy" class="aesthetic-image">
      </div>
    </div>
  </div>
</template>
...
.aesthetic-image-container {
  ...
  border-radius: 20px;
  box-shadow: 0 8px 24px rgba(177, 156, 217, 0.08);
  overflow: hidden;
}
...
.aesthetic-image:hover {
  ...
  box-shadow: 0 12px 28px rgba(177, 156, 217, 0.15);
